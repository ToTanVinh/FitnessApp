...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //
//    // Table and column names for Gym
//    public static final String GYM_TABLE_NAME = "gym";
//    public static final String GYM_COLUMN_ID = "gymID";
//    public static final String GYM_COLUMN_NAME = "gymName";
//    public static final String GYM_COLUMN_LOCATION = "location";
//
...
//
//    // Table and column names for Review
//    public static final String REVIEW_TABLE_NAME = "review";
//    public static final String REVIEW_COLUMN_ID = "reviewID";
//    public static final String REVIEW_COLUMN_USER_ID = "userID";
//    public static final String REVIEW_COLUMN_PRODUCT_ID = "productID";
//    public static final String REVIEW_COLUMN_RATING = "rating";
//    public static final String REVIEW_COLUMN_COMMENT = "comment";
    ...
    //
//    private static final String CREATE_GYM_TABLE =
//            "CREATE TABLE " + GYM_TABLE_NAME + " (" +
//                    GYM_COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
//                    GYM_COLUMN_NAME + " TEXT NOT NULL, " +
//                    GYM_COLUMN_LOCATION + " TEXT NOT NULL);";
//
...
//                    REVIEW_COLUMN_USER_ID + " INTEGER NOT NULL, " +
//                    REVIEW_COLUMN_PRODUCT_ID + " INTEGER NOT NULL, " +
//                    REVIEW_COLUMN_RATING + " INTEGER NOT NULL, " +
//                    REVIEW_COLUMN_COMMENT + " TEXT, " +
//                    "FOREIGN KEY (" + REVIEW_COLUMN_USER_ID + ") REFERENCES " + USER_TABLE_NAME + "(" + USER_COLUMN_ID + "), " +
//                    "FOREIGN KEY (" + REVIEW_COLUMN_PRODUCT_ID + ") REFERENCES " + PRODUCT_TABLE_NAME + "(" + PRODUCT_COLUMN_ID + "));";
    ...
    public static final String CART_COLUMN_ID = "product_id";
    public static final String CART_COLUMN_NAME = "product_name";
    public static final String CART_COLUMN_PRICE = "product_price";
    public static final String CART_COLUMN_QUANTITY = "product_quantity";
    ...
    private static final String CART_TABLE_CREATE =
            "CREATE TABLE " + CART_TABLE_NAME + " (" +
                    ...
                    CART_COLUMN_USER_ID + " INTEGER" + // Thêm cột user_id
                    ");";

    public static final String BILL_TABLE_NAME = "bill";
    public static final String BILL_COLUMN_ID = "bill_id";
    public static final String BILL_COLUMN_USER_ID = "user_id";
    public static final String BILL_COLUMN_CART_ID = "cart_id";
    public static final String BILL_COLUMN_TOTAL_AMOUNT = "total_amount";
    public static final String BILL_COLUMN_DATE = "bill_date";

    private static final String CREATE_BILL_TABLE =
            "CREATE TABLE " + BILL_TABLE_NAME + " (" +
                    BILL_COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                    BILL_COLUMN_USER_ID + " INTEGER NOT NULL, " +
                    BILL_COLUMN_CART_ID + " INTEGER NOT NULL, " +
                    BILL_COLUMN_TOTAL_AMOUNT + " REAL NOT NULL, " +
                    BILL_COLUMN_DATE + " TEXT, " +
                    "FOREIGN KEY (" + BILL_COLUMN_USER_ID + ") REFERENCES " + USER_TABLE_NAME + "(" + USER_COLUMN_ID + "), " +
                    "FOREIGN KEY (" + BILL_COLUMN_CART_ID + ") REFERENCES " + CART_TABLE_NAME + "(" + CART_COLUMN_ID + "));";
