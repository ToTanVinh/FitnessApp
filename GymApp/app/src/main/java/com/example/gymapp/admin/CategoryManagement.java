    ...
    private void showCategoryDetailsDialog(final Category category) {
        ...
        buttonDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rowsAffected > 0) {
                    Toast.makeText(CategoryManagement.this, "Xóa sản phẩm thành công!", Toast.LENGTH_SHORT).show();
                    updateCategoryList(); // Cập nhật danh sách sản phẩm
                    dialog.dismiss();
                } else {
                    Toast.makeText(CategoryManagement.this, "Lỗi khi xóa sản phẩm!", Toast.LENGTH_SHORT).show();
                }
            }
        });
